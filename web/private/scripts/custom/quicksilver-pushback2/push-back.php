...
pantheon_raise_dashboard_error('full repository: ' . $fullRepository);
pantheon_raise_dashboard_error('work directory: ' . $workDir);
pantheon_raise_dashboard_error('$upstreamRepoWithCredentials: ' . $upstreamRepoWithCredentials);
pantheon_raise_dashboard_error('buildmetadata', $buildMetadata);
